...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  'officers:promotion-block': 'Uprank-Sperre verwalten',
  ...
  'academy-tests:manage': 'Recruitment & Training Tests verwalten',
  ...
  'reports:view': 'Anzeigen & Personenakten ansehen (PD/FJD)',
  'reports:manage': 'Anzeigen aufnehmen & Akten pflegen',
  'reports:delete': 'Anzeigen & Personenakten löschen',
...
const IMPLIED_PERMISSIONS: Partial<Record<Permission, Permission[]>> = {
  ...
  'officers:promotion-block': ['officers:view'],
  ...
  'hr:manage': ['hr:view', 'officers:view', 'contracts:manage', 'contracts:view'],
  'contracts:view': ['officers:view'],
  'contracts:manage': ['contracts:view', 'officers:view'],
  'reports:manage': ['reports:view'],
  'reports:delete': ['reports:view', 'reports:manage'],
...
'internal-affairs:manage': ['internal-affairs:view', 'officers:view'],
  'lad:manage': ['lad:view', 'officers:view'],
  ...
  'unit-leadership:manage': ['officers:view', 'units:view'],
