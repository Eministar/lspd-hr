    ...
    <Shell>
      <div className="contract-no-print mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-[20px] font-semibold text-label">{signedContract.title}</h1>
      ...
      {signedContract.access === 'auditor' && (
        <div className="contract-no-print mb-5 rounded-[12px] border border-line bg-surface p-4">
          <div className="flex items-start gap-3">
            <Eye size={18} className="mt-0.5 shrink-0 text-blue" />
            <div>
              <p className="text-[13px] font-semibold text-label">Einsicht</p>
              <p className="mt-1 text-[12.5px] leading-5 text-label-2">
      ...
      {editable && (
        <div className="contract-no-print mb-5 rounded-[12px] border border-gold/30 bg-gold/5 p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[13px] font-semibold text-label">Vertrag ausfüllen und unterschreiben</p>
      ...
      {signedContract.status === 'SIGNED' && signedContract.access === 'signer' && (
        <div className="contract-no-print mt-5 flex items-start gap-3 rounded-[12px] border border-green/18 bg-green/10 p-4">
          ...
          <div>
            <p className="text-[13px] font-semibold text-label">Vertrag unterschrieben</p>
